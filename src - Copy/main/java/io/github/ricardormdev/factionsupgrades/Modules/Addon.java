...
public abstract class Addon {
    ...
    protected boolean locationIsInFaction(Location location) {
        return faction.getAllClaims().stream().anyMatch(fLocation -> fLocation.getChunk().equals(location.getChunk()));
    }
}
